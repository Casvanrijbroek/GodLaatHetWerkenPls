...
Vergeet niet Tensorflow te importeren in je project.
"""
...
def cnn_model(X_train, y_train, kernel_size, nb_filters, channels, nb_epoch, batch_size, nb_classes, nb_gpus):
    ...
    Zet de regel hieronder uit als je de GPU niet wil gebruiken.
    
    Mogelijk is dat niet genoeg, als GPU nog steeds gebruikt wordt voeg dan deze code toe hierboven:
    import os
...
if __name__ == '__main__':
    ...
    Mijn RAM vond 512x512 niet leuk dus ik zou eerst 256 doen en daarna kijken of dit 512 met gpu wel gaat.
    """
    ...
    Vul hier je paths in naar het sample_labels.csv bestand en het X_sample.npy bestand met de grootte die je wil.
    Zorg dat de grootte overeen komt met de img_rows en img_cols.
    """
    # Import data
    labels = pd.read_csv("D:\\ChestXray\\sample_labels.csv")
    X = np.load("D:\\ChestXray\\X_sample_256.npy")
